...
func load_settings() -> void:
	...
	# set audio settings
	AudioServer.set_bus_volume_linear(0, config_file.get_value("audio", "main_volume", 0.5)) # main
	AudioServer.set_bus_volume_linear(1, config_file.get_value("audio", "music_volume", 1.0)) # music
	AudioServer.set_bus_volume_linear(2, config_file.get_value("audio", "effect_volume", 1.0)) # sfx
	AudioServer.set_bus_volume_linear(3, config_file.get_value("audio", "ui_volume", 1.0)) # ui
